...
export default function App() {
  ...
  // Download QR cards for the currently selected rows
...
>
  ...
  // You already have "selectedRows" — if it's named differently, use your array of rows here.
  for (const r of selectedRows) {
    await mod.downloadQrCard({
      qrCanvasId: `qr-${r.id}`, // or whatever your canvas id scheme is
      url: r.url,
      name: r.name ?? r.title ?? '(no title)',

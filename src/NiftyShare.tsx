...
export default function NiftyShare({
  url,
  ...
  const xHref = `https://twitter.com/share?url=${encodeURIComponent(
    safeUrl ?? ''
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <div style={{ fontWeight: 700, paddingBottom: 10, textAlign: 'center', color: '#000' }}>
              Share
            </div>
